//''' -> '\x27'
  ...
  // the minimum version of jQuery we want
	...
	function initMyBookmarklet() {
      ...
      alert("jquery available -> starting script");
    ...
    function FJCTPmodifyHeadlineAndGragTable(html) {
        ...
        //Array.prototype.forEach.call(html.querySelectorAll("img[src*=\x22/images/pages/poi_crag.png\x22]"), function (element) {
    ...
    function FJCTPreplaceFrankenJuraPremiumTopoImage(html) {
        ...
        Array.prototype.forEach.call(html.querySelectorAll("a[href*=\x22/klettern/premium\x22]"), function (element) {
            if (verbose) alert("removing a: " + element.attributes.getNamedItem("href").value);
            element.parentElement.removeChild(element);
        });
        Array.prototype.forEach.call(html.querySelectorAll("img[src*=\x22/images/php/topo_db\x22]"), function (element) {
            if (verbose) alert("removing img: " + element.attributes.getNamedItem("src").value);
            element.parentElement.removeChild(element);
        });
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                if (pagehtml != null) {
                    ...
                    alert("error in received data for url=\x22" + href + "\x22");
                }
            }
        }
    ...
    function FJCTPreadPoiId(html) {
        ...
        if (poi == undefined) {
            ...
            Array.prototype.forEach.call(html.querySelectorAll("a[href*=\x22" + poiKey + "\x22]"), function (element) {
    ...
    function FJTCPreadGpsLocation(html) {
        ...
        //});
        //Array.prototype.forEach.call(html.querySelectorAll("img[src*=\x22/osm/tileproxy.php\x22]"), function (element) {
